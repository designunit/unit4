    ...
    return (
        <div className={s.container}>
            ...
            <Flex>
                <ul>
                    {[
                        ...
                        ['Елизавета Владимирова', 'главный архитектор проектов, выпусник программы Архитекторы.рф 2026'],
            ...
            <p style={{ padding: 'var(--content-padding)' }}>
                С нами работали: Елизавета Антониади, Александра Мусина, Алена Чеусова, Анастасия Матюшонок, Анастасия Эсмонтова, Анастасия Славина, Александра Майкова, Анита Попова, Антон Фруслов, Артем Никитин, Валера Газаров, Валентина Ермолаева, Вероника Серебрякова, Виктор Сергеев, Виктория Бинковская, Виктория Пашкова, Глеб Шатько, Григорий Балуев, Джульетта Боброва, Евгений Щукин, Елизавета Челнокова, Кирилл Петров, Марина Васильева, Марина Рейзберг, Марина Цай, Милана Платонова, Михаил Палькин, Никита Сидоров, Оля Чернякова, Павел Советников, Петр Шуба, Полина Мошель, Соня Шишкина, Роберт Галиакбаров, Эдуард Лефлер
            </p>
