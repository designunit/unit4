    ...
    return (
        <>
            ...
            <p style={{ padding: 'var(--content-padding)' }}>
                С нами работали: Анастасия Славина, Анита Попова, Артем Никитин, Валера Газаров, Вероника Серебрякова, Виктор Сергеев, Даниил Савинский, Джульетта Боброва, Екатерина Попова, Евгений Щукин, Елизавета Челнокова, Кирилл Петров, Макс Ивлев, Марина Цай, Михаил Палькин, Никита Сидоров, Николай Медведенко, Оля Чернякова, Петр Шуба, Соня Шишкина, Эдуард Лефлер
            </p>
