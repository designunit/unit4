...
<ImageSet
    items={[
        'https://unit4.io/files/park_scnd/07_1.jpg',
        'https://unit4.io/files/park_scnd/07_2.jpg',
    ]}
/>
...
<ImageSet
    items={[
        'https://unit4.io/files/park_scnd/03.jpg',
        'https://unit4.io/files/park_scnd/04.jpg',
    ]}
    layout={{
        slider: {
...
<ImageSet
    items={[
        'https://unit4.io/files/park_scnd/05.jpg',
        'https://unit4.io/files/park_scnd/06.jpg',
    ]}
    layout={{
        slider: {
            transition: 'crossfade',
