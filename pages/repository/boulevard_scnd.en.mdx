...
<ImageSet
    items={[
        'https://unit4.io/files/boulevard_scnd/01_1.jpg',
        'https://unit4.io/files/boulevard_scnd/01_2.jpg',
    ]}
/>
...
<ImageSet
    items={[
        'https://unit4.io/files/boulevard_scnd/07.jpg',
        'https://unit4.io/files/boulevard_scnd/08.jpg',
    ]}
    layout={{
        slider: {
...
<ImageSet
    items={[
        'https://unit4.io/files/boulevard_scnd/04.jpg',
        'https://unit4.io/files/boulevard_scnd/05.jpg',
    ]}
    layout={{
        slider: {
            transition: 'crossfade',
...
<ImageSet
    items={[
        'https://unit4.io/files/boulevard_scnd/02.jpg',
        'https://unit4.io/files/boulevard_scnd/03.jpg',
    ]}
    layout={{
        slider: {
            transition: 'crossfade',
