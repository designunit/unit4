        ...
        <Article>
            ...
            <ul>
                <p>Серия изделий для Центрального бульвара
                    ...
                    <a href={'chistopol'}
            ><br/>[ бульвар Чистополь фаза#1 ]</a></p>
            	...
            	<p>шорт-лист Премии ADD AWARDS в номинации Ланшафтный дизайн и городская среда
            	 <a href={'https://addawards.ru/nominations/detail.php?ELEMENT_ID=86102'}
            > [ по ссылке ]</a></p>
            </ul>
            ...
            <p>ХЛЕБ - олицетворяет самый успешный период в жизни города, когда он был вторым по значению городом губернии, и вместе с тем перспективы развития гастрономической культуры для культурной идентификации города в будущем - потенциал города к производству и ретрансляции гуманистических ценностей, поэзии и поэтики.</p>

            <p>ХРОНОМЕТР - способность города в прошлом и будущем к производству высокоточных инженерных решений и продуктов. Обращение к интеллектуальному потенциалу города.</p>

            <p>ВЕЛОСИПЕД - способность города в прошлом и будущем к инновационным изобретениям, даже если это и “переизобретение” велосипеда. Обращение к образу города-изобретателя.</p>
            
            <p>УМНЫЙ ГОРОД - город уже сейчас производит высокотехнологичные компоненты, имеющих потенциал глубокой интеграции в системы умного управления домами и городами.</p>
