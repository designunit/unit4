...
<ImageSet
    items={[
        'https://unit4.io/files/chistopol/04.jpg',
        'https://unit4.io/files/chistopol/03.jpg',
    ]}
/>

Canopies and pavilions on three squares, inviting thematic outdoor spaces, [design of hardscape elements](/repository/model_4) — all refers to important semantic blocks of life and history of the city: Vostok Watch Makers, agriculture, cycling culture, and components of a “smart city”.
...
<ImageSet
    items={[
        'https://unit4.io/files/chistopol/06.jpg',
        'https://unit4.io/files/chistopol/16.jpg',
    ]}
/>
...
<ImageSet
    items={[
        'https://unit4.io/files/chistopol/07.jpg',
        'https://unit4.io/files/chistopol/08.jpg',
    ]}
/>
...
<ImageSet
    items={[
        'https://unit4.io/files/chistopol/11.jpg',
        'https://unit4.io/files/chistopol/12.jpg',
    ]}
/>
